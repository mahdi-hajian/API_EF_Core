...
namespace API_CoreProject
{
    public class Startup
    {
        ...
        {
            var connectionString = Configuration.GetConnectionString("SampleData"); //SampleData >> "sqlite"
            services.AddDbContext<Mcontext>(cfg => cfg.UseSqlServer(connectionString)); //  UseSqlServer >> UseSqlite
